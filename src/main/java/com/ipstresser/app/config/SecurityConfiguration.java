...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .anonymous()
                .antMatchers("/admin/**", "/plans/delete/**", "/currencies/delete/**", "/articles/delete/**", "/about/comments/delete/**")
                .hasAnyAuthority("ADMIN", "ROOT")
                .antMatchers("/plans", "articles", "/currencies", "/contact", "/faq")
                .permitAll()
                ...
                .and()
                .logout().logoutUrl("/users/logout").invalidateHttpSession(true).logoutSuccessUrl("/index")
                .and()
                .exceptionHandling().accessDeniedPage("/home/launch");
